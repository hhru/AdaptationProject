    ...
    return (
      <div>
        <Row>
          <Col>
            <h5>
              Дорогой коллега, мы надеемся, что первые три месяца твоей работы прошли продуктивно и
              просим тебя максимально честно и объективно оценить работу коллег, которые имели
    ...
    return {
      questions: [
        ...
        },
        {
          id: 15,
          quest:
            'Оцени по 5-бальной шкале работу своего наставника,5-наивысший балл (доступность, доброжелательность, структурированность, полнота обучения), если балл 3 и ниже, просьба указать почему',
          answers: [
            {
              id: 0,
              text: '5',
        ...
        },
        {
          id: 16,
          quest:
            'Был ли кто то, кто помогал тебе с вхождением в должность по мимо наставника? Какую помощь он тебе оказывал?',
          answers: [],
        },
        {
          id: 17,
